...
/**
 * Service class for handling user-related operations, specifically for MongoDB. Implements Spring
 * Security's ReactiveUserDetailsService for reactive user details retrieval.
 */
@AllArgsConstructor
@Service
@Primary
...
public class MongoReactiveUserDetailsService implements ReactiveUserDetailsService {
     ...
     * @return A Mono emitting the created User object, or an error signal if creation fails (e.g.,
     *     duplicate username).
     */
